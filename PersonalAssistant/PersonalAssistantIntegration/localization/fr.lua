local PAIStrings = {
    ...
    SI_PA_MENU_INTEGRATION_LWC_PRECONDITION = "Note: Pour utiliser les options ci-dessous, il est nécessaire d'activer PABanking.",
    ...
    -- -----------------------------------------------------------------------------------------------------------------
    -- PAIntegration Menu --
    SI_PA_MENU_INTEGRATION_PAB_REQUIRED = "PABanking doit être activé",
    SI_PA_MENU_INTEGRATION_PAJ_REQUIRED = "PAJunk doit être activé",
