...
local PARStrings = {
    ...
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_ENABLE = table.concat({"Использовать кронные наборы ", GetString(SI_PA_MENU_BANKING_REPAIRKIT)}),
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_ENABLE_T = "???",
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_DURABILITY = "Средняя прочность %",
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_DURABILITY_T = "Вся экипировка ремонтируются только если её средняя прочность ниже или равна указанной",
    ...
    -- SI_PA_MENU_REPAIR_RECHARGE_DEFAULT_GEM = "",
    -- SI_PA_MENU_REPAIR_RECHARGE_DEFAULT_GEM_T = "",
    -- SI_PA_MENU_REPAIR_RECHARGE_CHATMODE = "Сообщение чата после зарядки",
    -- SI_PA_MENU_REPAIR_RECHARGE_CHATMODE_T = "Что показывать после зарядки экипированного оружия в окне чата",
