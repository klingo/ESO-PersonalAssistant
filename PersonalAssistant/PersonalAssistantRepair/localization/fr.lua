...
local PARStrings = {
    ...
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_ENABLE = "tbd", -- NOTE: not yet used ingame
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_ENABLE_T = "tbd", -- NOTE: not yet used ingame
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_DURABILITY = "tbd", -- NOTE: not yet used ingame
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_DURABILITY_T = "tbd", -- NOTE: not yet used ingame
