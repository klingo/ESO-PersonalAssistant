...
local PARStrings = {
    ...
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_ENABLE = "tbd",
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_ENABLE_T = "tbd",
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_DURABILITY = "tbd",
    -- SI_PA_MENU_REPAIR_REPAIRKIT_CROWN_DURABILITY_T = "tbd",
    ...
    -- SI_PA_MENU_REPAIR_RECHARGE_CHATMODE = "tbd",
    -- SI_PA_MENU_REPAIR_RECHARGE_CHATMODE_T = "tbd",
