...
local function initAddon(_, addOnName)
    ...
    PA.Repair.logger = PA.logger:CreateSubLogger(PAC.ADDON.NAME_RAW.REPAIR, PAC.COLORED_TEXTS_DEBUG.PAR)
    PA.Repair.logger:SetLibDebugLoggerEnabled(PASavedVars.Profile.Debug.libDebugLogger)
