...
local PABStrings = {
    ...
    SI_PA_DIALOG_BANKING_EXACTLY_PRE = "The %s should have exactly %d of the selected item.",
    SI_PA_DIALOG_BANKING_LESSTHANOREQUAL_PRE = "The %s should have at most (maximum) %d of the selected item.",
    SI_PA_DIALOG_BANKING_GREATERTHANOREQUAL_PRE = "The %s should have at least (minimum) %d of the selected item.",
    SI_PA_DIALOG_BANKING_EXPLANATION = "This means, if you have . . .",
    SI_PA_DIALOG_BANKING_EXACTLY_PRE = "The %s should have exactly %d of the selected item.",
    SI_PA_DIALOG_BANKING_EXACTLY_NOTHING = "> %d in your %s => nothing happens.",
    SI_PA_DIALOG_BANKING_EXACTLY_DEPOSIT = "> %d in your %s => transfers items to the %s until there are %d.",
    SI_PA_DIALOG_BANKING_FROM_TO_NOTHING = "> %d - %d in your %s => nothing happens.",
    SI_PA_DIALOG_BANKING_FROM_TO_DEPOSIT = "> %d - %d in your %s => transfers items to the %s until there are %d.",
    SI_PA_DIALOG_BANKING_FROM_TO_WITHDRAW = "> %d - %d in your %s => transfer items away from the %s until there are %d left.",
