...
--SafeAddString(SI_PA_MENU_BANKING_ADVANCED_INTRICATE_ITEMS, table.concat({GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE), " Gegenstände"}), 1) -- TODO: TAKIT
