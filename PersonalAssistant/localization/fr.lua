...
-- PABanking --
ResourceBundle.fr["PAB_GoldDeposited"]                  = PAC_COLTEXT_PAB.."%d "..PAC_ICON_CURRENCY_GOLD_SMALL.." déposées."
ResourceBundle.fr["PAB_GoldWithdrawn"]                  = PAC_COLTEXT_PAB.."%d "..PAC_ICON_CURRENCY_GOLD_SMALL.." retirées."
ResourceBundle.fr["PAB_GoldWithdrawnInsufficient"]      = PAC_COLTEXT_PAB.."%d / %d "..PAC_ICON_CURRENCY_GOLD_SMALL.." retirées. (Pas assez en banque !)"
...
ResourceBundle.fr["PABMenu_Currency_Gold_Enabled"]                = "Déposer de l'or"
ResourceBundle.fr["PABMenu_Currency_Gold_Enabled_T"]              = "Déposer automatiquement de l'or en banque ?"
ResourceBundle.fr["PABMenu_Currency_Gold_TransactionStep"]        = "- Déplacement d'or par tranche de :"
ResourceBundle.fr["PABMenu_Currency_Gold_TransactionStep_T"]      = "Par tranche de combien l'or doit être déposé ou retiré ?"
ResourceBundle.fr["PABMenu_Currency_Gold_MinToKeep"]              = "- Or minimum à garder sur soi"
ResourceBundle.fr["PABMenu_Currency_Gold_MinToKeep_T"]            = "Quantité d'or minimum à toujours conserver sur votre personnage."
ResourceBundle.fr["PABMenu_Currency_Gold_MinToKeep_W"]            = "Nombre non valide --> Aucun or ne sera conservé sur votre personnage."
ResourceBundle.fr["PABMenu_Currency_Gold_WithdrawToMin"]          = "- Retirer de l'or si en-dessous du minimum"
ResourceBundle.fr["PABMenu_Currency_Gold_WithdrawToMin_T"]        = "Retirer automatiquement de l'or de la banque quand le personnage en a moins que défini ci-dessus ?"
