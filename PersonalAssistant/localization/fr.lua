...
ResourceBundle.fr["PABMenu_DepositInterval"]            = "- Intervalle entre deux déposes (sec)"
ResourceBundle.fr["PABMenu_DepositInterval_T"]          = "Temps minimum en secondes entre deux déposes automatiques d'or."
ResourceBundle.fr["PABMenu_DepositInterval_W"]          = "Nombre non valide --> Pas de temps minimum entre les déposes."
ResourceBundle.fr["PABMenu_DepositGoldPerc"]            = "- Or à déposer en %"
ResourceBundle.fr["PABMenu_DepositGoldPerc_T"]          = "Pourcentage maximum de votre or à déposer."
