...
ResourceBundle.en["PALMenu_LootItems"]              = "Auto-Loot harvestable items"
ResourceBundle.en["PALMenu_LootItems_T"]            = "Automatically loot harvestable items?"
ResourceBundle.en["PALMenu_HarvestableItemsDesc"] 	= "Enable and disable auto-loot for harvestable items from ores, herbs, woods, runestones, or fishing holes."
