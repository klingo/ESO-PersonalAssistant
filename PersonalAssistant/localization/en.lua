...
ResourceBundle.en["PABMenu_DepositInterval"] 		= "- Min interval between deposits (sec)"
ResourceBundle.en["PABMenu_DepositInterval_T"] 		= "Minimum time in seconds between two automatic gold deposits."
ResourceBundle.en["PABMenu_DepositInterval_W"] 		= "Invalid number --> No minimum interval between deposits."
ResourceBundle.en["PABMenu_DepositGoldPerc"] 		= "- Gold to deposit in %"
ResourceBundle.en["PABMenu_DepositGoldPerc_T"] 	    = "Maximum percentage of your current gold to be deposited."
...
ResourceBundle.en["PALMenu_LootButton"] 			= "Auto-Loot all"
ResourceBundle.en["PALMenu_LootButton_T"] 			= "Change all dropdown values to 'Auto-Loot'"
ResourceBundle.en["PALMenu_IgnButton"] 			    = "Disable all"
ResourceBundle.en["PALMenu_IgnButton_T"] 			= "Change all dropdown values to '-'"
