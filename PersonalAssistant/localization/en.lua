...
local PAStrings = {
    ...
    SI_PA_MENU_BANKING_ADVANCED_FOOD_DRINKS = "Food & Drinks",
...
local PAGenericStrings = {
    ...
    SI_PA_MENU_BANKING_ADVANCED_FOOD_DRINKS_HEADER = table.concat({" ", PAC.ICONS.ITEMS.FOOD.NORMAL, "  ", GetString(SI_PA_MENU_BANKING_ADVANCED_FOOD_DRINKS)}),
    SI_PA_MENU_BANKING_ADVANCED_TROPHIES_HEADER = table.concat({" ", PAC.ICONS.ITEMS.TREASURE_MAP.NORMAL, "  ", zo_strformat("<<m:1>>", GetString("SI_ITEMTYPE", ITEMTYPE_TROPHY))}),
