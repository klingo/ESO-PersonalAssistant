...
-- PABanking --
ResourceBundle.de["PAB_GoldDeposited"]                  = PAC_COLTEXT_PAB.."%d "..PAC_ICON_CURRENCY[CURT_MONEY].SMALL.." eingelagert."
ResourceBundle.de["PAB_GoldWithdrawn"]                  = PAC_COLTEXT_PAB.."%d "..PAC_ICON_CURRENCY[CURT_MONEY].SMALL.." abgehoben."
ResourceBundle.de["PAB_GoldWithdrawnInsufficient"]      = PAC_COLTEXT_PAB.."%d / %d "..PAC_ICON_CURRENCY[CURT_MONEY].SMALL.." abgehoben. (Nicht genug Gold in Truhe)"
...
ResourceBundle.de["PABMenu_Currency_Gold_Enabled"]                = "Gold einlagen"
ResourceBundle.de["PABMenu_Currency_Gold_Enabled_T"]              = "Soll automatisch Gold in die Truhe eingelagert werden?"
ResourceBundle.de["PABMenu_Currency_Gold_TransactionStep"]        = "- Gold Transaktionen in Schritten von"
ResourceBundle.de["PABMenu_Currency_Gold_TransactionStep_T"]      = "In welchen Schritten soll Gold eingelagert und abgehoben werden?"
ResourceBundle.de["PABMenu_Currency_Gold_MinToKeep"]              = "- Min. Gold im Inventar behalten"
ResourceBundle.de["PABMenu_Currency_Gold_MinToKeep_T"]            = "Minimalmenge an Gold die immer im Inventar behalten werden soll."
ResourceBundle.de["PABMenu_Currency_Gold_MinToKeep_W"]            = "Ungültige Eingabe --> Kein Gold soll im Inventar behalten werden."
ResourceBundle.de["PABMenu_Currency_Gold_WithdrawToMin"]          = "- Hebe Gold ab wenn unter Minimum"
ResourceBundle.de["PABMenu_Currency_Gold_WithdrawToMin_T"]        = "Soll automatisch Gold von der Truhe abgehoben werden, wenn weniger Gold im Inventar ist wie oben als Minimum definiert wurde."
