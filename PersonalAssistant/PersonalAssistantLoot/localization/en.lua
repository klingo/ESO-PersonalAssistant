...
local PALStrings = {
    ...
    SI_PA_MENU_LOOT_APPARELWEAPONS_UNKNOWN_MSG_T = table.concat({"Whenever an ", GetString("SI_ITEMFILTERTYPE", ITEMFILTERTYPE_ARMOR), " or a ", GetString("SI_ITEMFILTERTYPE", ITEMFILTERTYPE_WEAPONS), " is lootet that has a trait that is not yet research by this character, a message is displayed in the chat"}),
