...
ResourceBundle.fr["PAB_Junk_NoJunk"]				= "(en) no junk at all"
ResourceBundle.fr["PAB_Junk_ItemTypeJunk"]			= "(en) depending on item type setting"
ResourceBundle.fr["PAB_Junk_AllJunkDep"]			= "(en) all junk (Deposit only!)"
ResourceBundle.fr["PAB_Junk_AllJunkWit"]			= "(en) all junk (Withdraw only!)"
...
ResourceBundle.fr["PABMenu_ItemJunk_Header"]		= "(en) "..PAC_COL_LIGHT_BLUE.."ITEMS MARKED AS JUNK"
ResourceBundle.fr["PABMenu_DepItemJunk"] 			= "(en) Junk Items: Deposit/Withdraw ..."
ResourceBundle.fr["PABMenu_DepItemJunk_T"] 			= "(en) Shall all items that are marked as junk, only the ones for which their item type is enabled or none at all be deposited to or withdrawn from the bank?"
ResourceBundle.fr["PABMenu_ItemType_Header"]		= "(en) "..PAC_COL_LIGHT_BLUE.."ITEM TYPES"
...
ResourceBundle.fr[ITEMTYPE_ENCHANTING_RUNE] 		= "Pierre runique (Enchantement)"
...
ResourceBundle.fr[ITEMTYPE_SCROLL] 					= "frITEMTYPE_SCROLL"
