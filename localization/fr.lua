...
ResourceBundle.fr["PABMenu_DepItemJunk"] 			= "- Déposer les objets notés 'rebuts'"
ResourceBundle.fr["PABMenu_DepItemJunk_T"] 			= "Les objets marqués comme rebuts doivent également être déposés en banque ?"
...
ResourceBundle.fr[ITEMTYPE_ALCHEMY_BASE] 			= "Solvent (Alchimie)"
...
ResourceBundle.fr[ITEMTYPE_TRASH]					= "frITEMTYPE_TRASH"
