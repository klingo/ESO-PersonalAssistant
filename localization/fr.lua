...
ResourceBundle.fr["PAB_Junk_ItemTypeJunk"]			= "(en) only junk of enabled item types"
ResourceBundle.fr["PAB_Junk_AllJunk"]				= "(en) all junk items"
...
ResourceBundle.fr["PABMenu_DepItemJunk_T"] 			= "(en) Shall all items that are marked as junk, only the ones for which their item type is enabled or none at all be deposited to the bank?"
