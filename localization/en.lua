...
ResourceBundle.en["PAB_Junk_ItemTypeJunk"]			= "only junk of enabled item types"
ResourceBundle.en["PAB_Junk_AllJunk"]				= "all junk items"
...
ResourceBundle.en["PABMenu_DepItemJunk"] 			= "- Junk Items: Deposit/Withdraw ..."
ResourceBundle.en["PABMenu_DepItemJunk_T"] 			= "Shall all items that are marked as junk, only the ones for which their item type is enabled or none at all be deposited to the bank?"
